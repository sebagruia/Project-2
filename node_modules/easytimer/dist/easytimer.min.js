...
! function (t, n) {
    ...
    function e() {
        var n, e, o, i, s, r, u, c, a, d, f = new I,
            h = new I,
            l = K() ? document.createElement("span") : N() ? new J.EventEmitter : void 0,
            p = !1,
            v = !1,
            m = {},
            y = {
        ...
        function g(t) {
            O() ? (a = E(), r = V(s.target)) : function (t) {
                    e = "string" == typeof (t = t || {}).precision ? t.precision : z, i = "function" == typeof t.callback ? t.callback : function () {}, c = !0 === t.countdown, o = !0 === c ? -1 : 1, "object" === q(t.startValues) ? (n = t.startValues, u = L(n), f.secondTenths = u[0], f.seconds = u[1], f.minutes = u[2], f.hours = u[3], f.days = u[4], h = x(u, h)) : u = null;
                    var n;
                    a = E(), j(), r = "object" === q(t.target) ? V(t.target) : c ? (t.target = {
                        seconds: 0
                    }, V(t.target)) : null;
                    m = {
                        precision: e,
